/*
 * BLE scan logger for sensor unit (ESP32-S3) using NimBLE.
 * Scans for CONFIG_SENSOR_BLE_SCAN_DURATION_SEC (default 20 s), then waits until
 * CONFIG_SENSOR_BLE_SCAN_PERIOD_SEC (default 60 s) before starting the next scan.
